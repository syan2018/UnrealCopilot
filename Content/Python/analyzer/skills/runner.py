...
class SkillRunner:
    ...
    def list_skills(self, query: Optional[str] = None) -> Dict[str, Any]:
    ...
    def _resolve_default_skills_root(self) -> Path:
        # .../Plugins/UnrealProjectAnalyzer/Content/Python/analyzer/skills/runner.py
        # skill root: .../Plugins/UnrealProjectAnalyzer/skills
